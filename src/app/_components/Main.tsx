  ...
  return (
    <main className="h-[60dvh] sm:h-[80dvh]">
      <div className="flex h-full bg-white/20 bg-blend-overlay sm:bg-gradient sm:bg-contain sm:bg-center sm:bg-no-repeat sm:p-3">
        ...
        <div className="flex h-full flex-1 flex-col items-center justify-center gap-y-3 bg-gradient bg-cover bg-center bg-no-repeat p-3 bg-blend-overlay sm:bg-none sm:p-0">
